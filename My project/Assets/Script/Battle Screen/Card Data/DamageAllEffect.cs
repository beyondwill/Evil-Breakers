...
[CreateAssetMenu(menuName = "Card/Effects/Damage All")]
public class DamageAllEffect : CardEffect
{
    public override void Execute(
        ...
        CardData card)
    {
        targets = caster.is_player_character ?  BattleCharacterManager.Instance.EnemyCharacters : BattleCharacterManager.Instance.PlayerCharacters;
